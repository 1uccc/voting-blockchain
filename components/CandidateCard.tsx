  ...
  return (
    <div className="group glass-card p-5 flex flex-col gap-4 hover:border-primary/40 hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
      <div className="flex items-center gap-4">
        <div
          className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${color} flex items-center justify-center text-white text-xl font-bold shadow-lg flex-shrink-0`}
        >
          {initials}
        </div>
      ...
      {candidate.manifesto && (
        <div className="bg-background/40 rounded-xl px-4 py-3 border border-border/30">
          <p className="text-xs text-muted uppercase tracking-wider font-semibold mb-1.5">
      ...
      >
        ...
        Bỏ phiếu cho {candidate.name.split(" ")[0]}
      </button>
    </div>
  );
};
